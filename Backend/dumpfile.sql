...
CREATE TABLE `account` (
  ...
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `bank` (`bank_id`),
  CONSTRAINT `account_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`)
...
INSERT INTO `account` VALUES (1,'10000',1,1),(2,'20000',1,2),(3,'15000',2,1);
...
CREATE TABLE `advertise` (
  ...
  KEY `maketing_id_idx` (`marketing_id`),
  CONSTRAINT `maketing_id` FOREIGN KEY (`marketing_id`) REFERENCES `marketing` (`marketing_id`)
...
INSERT INTO `advertise` VALUES (2,'Marketing for promoting studentguru ',1),(3,'digital adds for studentguru on social media',2);
...
CREATE TABLE `answer` (
  ...
  `ans_description` varchar(2000) DEFAULT NULL,
  `student_id` int DEFAULT NULL,
...
INSERT INTO `answer` VALUES (1,1,'You can go for engineering. if you have any doubts about the stream to choose, reach out at sushobhan@studentguru.com ',1,1),(2,2,'You can go for Medical back ground. if you have any other interest mention them.',2,1),(3,4,'as you have interest in biology and chemistry, you can go for Bio-chemistry',4,1),(4,3,'You can go for Law or civil services or goverment jobs',3,1),(8,12,'After 2 valid semesters',1,1),(9,13,'33',1,1),(10,14,NULL,2,1);
...
CREATE TABLE `art` (
  ...
  CONSTRAINT `art_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `art` VALUES (1,'abcart@studentguru.com','7000000003',1),(2,'canvasart@studentgiri.com','7000000004',2),(3,'xyz@studentguru.com','7000000005',3);
...
INSERT INTO `bank` VALUES (1,'SBI','sbi@studentguru.com',19,1),(2,'American','american@studentguru.com',20,2);
...
CREATE TABLE `comments` (
  ...
  KEY `query_id` (`query_id`),
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`query_id`) REFERENCES `queries` (`query_id`)
...
INSERT INTO `comments` VALUES (1,'very good question',1),(2,'common question',2),(3,'unusual choosen stream ',3),(4,'very rare question',4);
...
INSERT INTO `company` VALUES (3,'Jfinance','jfinance@studentguru.com','9000030000'),(123,'Engg solutions','enggsolutions@studentguru.com','9000010000'),(124,'Ooha Hospitals','oohahospital@studentguru.com','9000020000');
...
CREATE TABLE `dislikes` (
  ...
  KEY `query_id` (`query_id`),
  CONSTRAINT `dislikes_ibfk_1` FOREIGN KEY (`query_id`) REFERENCES `queries` (`query_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dislikes` VALUES (3,1),(4,1),(2,2),(1,3);
...
CREATE TABLE `engineering` (
  `engineering_id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(45) DEFAULT NULL,
  `mobile` varchar(10) DEFAULT NULL,
  `university_id` int DEFAULT NULL,
  PRIMARY KEY (`engineering_id`),
  KEY `university_id` (`university_id`),
  CONSTRAINT `engineering_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `engineering` VALUES (1,'abcengg@studentguru.com','7000000006',1),(2,'canvasengg@studentguru.com','7000000007',2),(3,'xyxengg@studentguru.com','7000000008',3);
...
CREATE TABLE `faculty` (
  ...
  KEY `mobile_id` (`mobile_id`),
  CONSTRAINT `faculty_ibfk_1` FOREIGN KEY (`mobile_id`) REFERENCES `mobile` (`mobile_id`)
...
INSERT INTO `faculty` VALUES (1,'sushobhan','sushobhan@studentguru.com','123456789',5),(2,'bhanu','bhanu@studentguru.com','123456789',4),(3,'ooha','ooha@studentguru.com','123456789',6);
...
CREATE TABLE `finance` (
  ...
  KEY `university_id` (`university_id`),
  CONSTRAINT `finance_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
...
INSERT INTO `finance` VALUES (1,'abcfin@studentguru.com','7000000009',1),(2,'canvasfin@studentguru.com','8000000008',2),(3,'xyzfin@studentguru.com','8000000009',3);
...
INSERT INTO `internship` VALUES (1,'software',123,1,'amazon','intern@amazon.com'),(2,'datascience',124,2,'NTT Data','intern@nttdata.com');
...
CREATE TABLE `law` (
  ...
  PRIMARY KEY (`law_id`),
  KEY `university_id` (`university_id`),
  CONSTRAINT `law_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `law` VALUES (1,'abclaw@studentguru.com','7500000000',1),(2,'canvaslaw@studentguru.com','7500000001',2),(3,'xyzlaw@studentguru.com','7500000002',3);
...
CREATE TABLE `like` (
  ...
  CONSTRAINT `query_id` FOREIGN KEY (`query_id`) REFERENCES `queries` (`query_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `like` VALUES (3,1),(1,2),(4,2),(2,3);
...
CREATE TABLE `loan` (
  ...
  CONSTRAINT `bank_id` FOREIGN KEY (`bank_id`) REFERENCES `bank` (`bank_id`),
...
INSERT INTO `loan` VALUES (1,'1500000',1,1),(2,'1000000',2,2);
...
INSERT INTO `marketing` VALUES (1,'jo','8000000000','marketing','jo@studentguru.com'),(2,'su','8000000001','digital marketing','su@studentguru.com');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mba` (
  `mba_id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(45) DEFAULT NULL,
  `mobile` varchar(10) DEFAULT NULL,
  `university_id` int DEFAULT NULL,
  PRIMARY KEY (`mba_id`),
  KEY `university_id` (`university_id`),
  CONSTRAINT `mba_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `mba` WRITE;
/*!40000 ALTER TABLE `mba` DISABLE KEYS */;
INSERT INTO `mba` VALUES (1,'abcmba@studentguru.com','7500000003',1),(2,'canvasmba@studentguru.com','7500000004',2),(3,'xyzmba@studentguru.com','7500000005',3);
/*!40000 ALTER TABLE `mba` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `medical` (
  ...
  KEY `university_id` (`university_id`),
  CONSTRAINT `medical_ibfk_1` FOREIGN KEY (`university_id`) REFERENCES `university` (`university_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `medical` VALUES (1,'abcmedical@studentguru.com','7500000007',1),(2,'canvasmedical@studentguru.com','7500000008',2),(3,'xyzmedical@studentguru.com','7500000009',3);
...
INSERT INTO `mobile` VALUES (19,'9403314775',1),(20,'9405956251',2);
...
INSERT INTO `queries` VALUES (1,'MPC','I have very much interest in maths and physic, Which stream should i apply?','enineering',NULL,1,1),(2,'biology','I have very good knowledge in Biology which steam should i appply?','Medical',NULL,2,1),(3,'social','I am interested in social science, which stream should i apply?','social science',NULL,3,1),(4,'chemistry','I am good at chemistry, which stream should i apply','chemistry',NULL,2,1),(12,NULL,'When can I start my Internship','Internship',NULL,1,1),(13,NULL,'How many credits do I need to complete my course?','Credits',NULL,1,1),(14,NULL,'What are the subjects am I allowed to take next semester?','Subjects',NULL,2,1);
...
CREATE TABLE `student` (
  ...
  KEY `mobile_id` (`mobile_id`),
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`mobile_id`) REFERENCES `mobile` (`mobile_id`)
...
INSERT INTO `student` VALUES (1,'Chandhu','Chandhu@studentguru.com','123456789',19),(2,'Akhil','Akhil@studentguru.com','123456789',20);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-01-24 16:15:44',NULL),('diagnostics.include_raw','OFF','2022-01-24 16:15:44',NULL),('ps_thread_trx_info.max_length','65535','2022-01-24 16:15:44',NULL),('statement_performance_analyzer.limit','100','2022-01-24 16:15:44',NULL),('statement_performance_analyzer.view',NULL,'2022-01-24 16:15:44',NULL),('statement_truncate_len','64','2022-01-24 16:15:44',NULL);
...
INSERT INTO `university` VALUES (1,'University of North Texas (UNT)','unt@studentguru.com','9000000000',1),(2,'University of North Texas (UNT)','unt@studentguru.com','9000000001',2),(3,'xyz','xyz@studentguru.com','9000000002',NULL);
...
-- Dump completed on 2022-04-24 16:01:52
